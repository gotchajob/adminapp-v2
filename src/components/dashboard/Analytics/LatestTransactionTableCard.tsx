...
const LatestTransactionTableCard = () => (
  <MainCard title="Latest Transactions" content={false}>
    <PerfectScrollbar style={{ height: 465, padding: 0 }}>
      <TableContainer>
        <Table>
          <TableHead>
            <TableRow>
...
export default LatestTransactionTableCard;
