...
const TotalUserIcon = '/assets/images/icons/person-svgrepo-com.svg';
...
const TotalUserCard = ({ isLoading }: TotalUserCardProps) => {
              ...
              <Grid item>
                <Grid container justifyContent="space-between">
                  <Grid item>
                    ...
                    >
                      <Image src={TotalUserIcon} height={30} width={30} alt="Notification" style={{ maxWidth: '100%', height: 'auto' }} />
                    </Avatar>
                  </Grid>
                  <Grid item>
                    <Avatar
