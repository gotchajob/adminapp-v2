...
const NewUserIcon = '/assets/images/icons/person-add-svgrepo-com.svg';
...
interface NewUserLineChartCardProps {
  isLoading: boolean;
}

const NewUserLineChartCard = ({ isLoading }: NewUserLineChartCardProps) => {
              ...
              <Grid item>
                <Grid container justifyContent="space-between">
                  <Grid item>
                    ...
                    >
                      <Image src={NewUserIcon} height={30} width={30} alt="Notification" style={{ maxWidth: '100%', height: 'auto' }} />
                    </Avatar>
                  </Grid>
                  <Grid item>
                    <Button
                    ...
                    <Grid container alignItems="center">
                      <Grid item>
                        {timeValue ? (
                          ...
                          <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>100</Typography>
                        )}
                      </Grid>
                      <Grid item>
                        <Avatar
...
export default NewUserLineChartCard;
