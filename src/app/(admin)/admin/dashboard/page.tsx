...
const Dashboard = () => {
    ...
    return (
        <Grid container spacing={gridSpacing}>
            ...
            <Grid item xs={12}>
                <Grid container spacing={gridSpacing}>
                    <Grid item lg={3} md={3} sm={3} xs={3}><TransactionCard isLoading={isLoading} /></Grid>
                    <Grid item lg={3} md={3} sm={3} xs={3}><RevenueCard2 isLoading={isLoading} /></Grid>
                    <Grid item lg={3} md={3} sm={3} xs={3}><TotalTransactionCard isLoading={isLoading} /></Grid>
                    <Grid item lg={3} md={3} sm={3} xs={3}><TotalRevenueCard isLoading={isLoading} /></Grid>
                </Grid>
            </Grid>
            <Grid item xs={12}>
                <Grid container spacing={gridSpacing}>
                    <Grid item lg={8} md={8} xs={12}><TotalTransactionBarChart isLoading={isLoading}></TotalTransactionBarChart></Grid>
                    <Grid item lg={4} md={8} xs={12}><LatestTransactionTableCard></LatestTransactionTableCard></Grid>
                </Grid>
            </Grid>
            <Grid item xs={12}>
                <Grid container spacing={gridSpacing}>
                    <Grid item lg={8} md={8} xs={12}><TotalRevenueBarChart isLoading={isLoading}></TotalRevenueBarChart></Grid>
                    <Grid item lg={4} md={8} xs={12}><TotalRevenueCard2></TotalRevenueCard2></Grid>
                </Grid>
            </Grid>
        </Grid>
    );
