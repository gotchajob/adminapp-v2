                ...
                <MainCard>
                    <Grid container spacing={1}>
                                    ...
                                    <Grid container alignItems="center" spacing={1}>
                                        ...
                                        <Grid item>
                                            <Typography variant="caption">
                                                <FiberManualRecordIcon sx={{ width: '10px', height: '10px', opacity: 0.5, m: '0 5px' }} />12 June 2024
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </Grid>
                        ...
                        <Grid item xs={12} sx={{ '& > p': { ...theme.typography.body1, mb: 0 } }}>
                            <Markdown remarkPlugins={[remarkGfm]}>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. There are many variations of passages.</Markdown>
                        </Grid>
