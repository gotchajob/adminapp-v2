...
export const RenderTransactionCurrentWithdrawTable = ({ transactionCurrentWithdraw }: { transactionCurrentWithdraw: TransactionCurrentWithdrawRes }) => {
    ...
    const filteredData = useMemo(() => {
        ...
        if (text && text !== '') {
            const filteredIndex = findAllIndexByAnyField(data, text);
            data = data.filter((_, index) => filteredIndex.includes(index));
        }
        return data;
    }, [text, transactionCurrentWithdraw]);
