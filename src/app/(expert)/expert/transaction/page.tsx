...
import { Box, CircularProgress, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, IconButton, Tooltip, Pagination } from '@mui/material';
...
export default function TransactionPage() {
    ...
    return (
        <SubCard title="Danh sách giao dịch thành công">
            <TableContainer>
                <Table>
                    <TableHead >
                        <TableRow>
                        ...
                        {transactionCurrentLoading ? (
                            ...
                            transactionCurrent.list.map((transaction: TransactionCurrent) => (
                                <TableRow hover key={transaction.id}>
                                    <TableCell sx={{ pl: 3, fontWeight: 500 }}>{transaction.id}</TableCell>
                                    <TableCell sx={{ pl: 3 }}>{transaction.amount.toLocaleString()} VND</TableCell>
                            ...
                            <TableRow hover>
                                <TableCell colSpan={6} align="center">Hiện chưa có giao dịch nào.</TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                </Table>
                <Box sx={{ display: 'flex', justifyContent: 'center', paddingY: 3 }}>
                    <Pagination
                        count={Math.ceil(transactionCurrent.totalPage * rowsPerPage / rowsPerPage)}
                        page={page + 1}
