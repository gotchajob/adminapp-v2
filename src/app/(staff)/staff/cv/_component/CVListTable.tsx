...
export const RenderCVListTable = ({
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      flex: 2,
      renderCell: (params) => (
        <NextLink href={`/staff/cv/` + params.id} passHref>
    ...
    },
    {
      ...
      renderCell: (params) => {
        ...
        const category = cvCategory.find(
    ...
    },
    {
      ...
      flex: 1.5,
      renderCell: (params) => (
        <Typography align="center">{params.value} lượt</Typography>
      ),
    },
    {
      field: "createdAt",
  ...
  const filteredData = useMemo(() => {
    ...
    return cvTemplateStaffList.filter((item) => {
      const categoryDescription =
        cvCategory
          .find((category) => category.id === item.cvCategoryId)
