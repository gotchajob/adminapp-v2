...
import { Box, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Grid } from '@mui/material';
...
const ExpertList = () => {
    ...
    const { expertList, loading } = useGetExpertList(params, refreshTime);
        ...
        <TableContainer>
                                    ...
                                    <TableRow hover key={index}>
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            ...
                                            <Stack direction="row" justifyContent="center" alignItems="center">
                                                {row.userStatus === 0 ? (<Tooltip placement="top" title="Mở khóa">
                                                    <IconButton
                                                        color="primary"
                                                        aria-label="approve"
                                                        size="large"
                                                ...
                                                </Tooltip>) : (<Tooltip placement="top" title="Khóa">
                                                    <IconButton
                                                        color="primary"
                                                        sx={{
                                                            color: 'orange.dark',
            ...
            <Dialog open={Boolean(expertBan)} maxWidth="xs" fullWidth>
                ...
                <DialogActions>
                    ...
                    <LoadingButton loading={isLoading} onClick={BanExpert}> Khóa</LoadingButton>
                </DialogActions>
            </Dialog>
